...
- [HTTP API endpoints](http-api.md) - Next.js route handlers for Source intake, Prepared Evidence, Story management, Source inbox, and triage, with request shapes and status code maps.
- [Newsroom UI shell](newsroom-ui.md) - Resizable React newsroom workbench with a Story desk, Source-evidence intake, Source inbox, Agent Profiles, and a Story workspace covering assignment, Writer execution, review submission, Director review, operator decisions, and Article reading.

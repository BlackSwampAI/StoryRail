...
export const MODEL_FAILURE_CODES = [
  ...
  // Local execution stopped before StoryRail could establish a normal result. Not a provider
  // problem, and naming it as one would send the operator looking in the wrong place.
  "MODEL_RUN_ABANDONED",

...
export type StoryDeliveryReconciliationId = Identifier<"StoryDeliveryReconciliationId">;
...
export const storyDeliveryReconciliationId = (value: string): StoryDeliveryReconciliationId =>
  value as StoryDeliveryReconciliationId;
